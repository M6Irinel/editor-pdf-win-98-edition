...
function TextEditor({ canvasRef, onTextAdd }) {
  ...
  useEffect(() => {
    const handleClickOutside = (e) => {
      if (isEditing && inputRef.current && !inputRef.current.contains(e.target) && controlsRef.current && !controlsRef.current.contains(e.target)) {
        handleTextSubmit();
      }
    };
  ...
  }, [isEditing, text, position, fontSize, fontWeight, color]);
